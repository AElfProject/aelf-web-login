...
packages.forEach((key: string) => {
  moduleNameMapper[`@aelf-web-login/${key}/test/(.+)$`] = `<rootDir>/packages/${key}/test/$1`;
  moduleNameMapper[`@aelf-web-login/${key}`] = `<rootDir>/packages/${key}/src`;
});
...
export default {
  ...
  // cacheDirectory: "/private/var/folders/r5/t47_1bgs5cldtw053qqg01hw0000gn/T/jest_dx",
