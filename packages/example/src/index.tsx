...
import { WebLoginInstance, WebLoginProvider } from 'aelf-web-login-v2';
...
function Index() {
  ...
  return (
    <portkeyInstance.PortkeyProvider networkType="TESTNET" theme="dark">
      <WebLoginProvider
        // commonConfig={{
        //   showClose: true,
        //   iconSrc:
    ...
    </portkeyInstance.PortkeyProvider>
  );
}
