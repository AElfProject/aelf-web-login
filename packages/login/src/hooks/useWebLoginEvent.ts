...
import { Accounts, ChainIds, NetworkType, ProviderError } from '@portkey/provider-types';
...
export default function useWebLoginEvent(
  eventType: WebLoginEvents.DISCOVER_DISCONNECTED,
  callback: (error: ProviderError) => void,
): void;
export default function useWebLoginEvent(
